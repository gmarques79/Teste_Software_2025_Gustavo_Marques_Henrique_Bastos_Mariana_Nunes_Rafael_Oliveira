...
def x__get_code_type__mutmut_orig(format_type: str):
...
def x__get_code_type__mutmut_1(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "XXnumericXX"
    if format_type.isalpha():
...
def x__get_code_type__mutmut_2(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "NUMERIC"
    if format_type.isalpha():
...
def x__get_code_type__mutmut_3(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "numeric"
    if format_type.isalpha():
...
def x__get_code_type__mutmut_4(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "numeric"
    if format_type.isalpha():
...
def x__get_code_type__mutmut_5(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "numeric"
    if format_type.isalpha():
...
def x__get_code_type__mutmut_6(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "numeric"
    if format_type.isalpha():
...
def x__get_code_type__mutmut_7(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "numeric"
    if format_type.isalpha():
...
def x__get_code_type__mutmut_8(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "numeric"
    if format_type.isalpha():
        if len(format_type) == 2:
            return "alpha2"
        if len(format_type) == 4:
            return "alpha3"
    return "invalid"
# fmt: on


def x__get_code_type__mutmut_9(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "numeric"
    if format_type.isalpha():
...
def x__get_code_type__mutmut_10(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "numeric"
    if format_type.isalpha():
...
def x__get_code_type__mutmut_11(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "numeric"
    if format_type.isalpha():
...
def x__get_code_type__mutmut_12(format_type: str):
    """Returns the type of country code."""
    if format_type.isdecimal():
        return "numeric"
    if format_type.isalpha():
...
x__get_code_type__mutmut_mutants : ClassVar[MutantDict] = {
'x__get_code_type__mutmut_1': x__get_code_type__mutmut_1, 
    'x__get_code_type__mutmut_2': x__get_code_type__mutmut_2, 
    'x__get_code_type__mutmut_3': x__get_code_type__mutmut_3, 
    'x__get_code_type__mutmut_4': x__get_code_type__mutmut_4, 
    'x__get_code_type__mutmut_5': x__get_code_type__mutmut_5, 
    'x__get_code_type__mutmut_6': x__get_code_type__mutmut_6, 
    'x__get_code_type__mutmut_7': x__get_code_type__mutmut_7, 
    'x__get_code_type__mutmut_8': x__get_code_type__mutmut_8, 
    'x__get_code_type__mutmut_9': x__get_code_type__mutmut_9, 
    'x__get_code_type__mutmut_10': x__get_code_type__mutmut_10, 
    'x__get_code_type__mutmut_11': x__get_code_type__mutmut_11, 
    'x__get_code_type__mutmut_12': x__get_code_type__mutmut_12
}

def _get_code_type(*args, **kwargs):
    result = _mutmut_trampoline(x__get_code_type__mutmut_orig, x__get_code_type__mutmut_mutants, args, kwargs)
    return result 

_get_code_type.__signature__ = _mutmut_signature(x__get_code_type__mutmut_orig)
x__get_code_type__mutmut_orig.__name__ = 'x__get_code_type'
