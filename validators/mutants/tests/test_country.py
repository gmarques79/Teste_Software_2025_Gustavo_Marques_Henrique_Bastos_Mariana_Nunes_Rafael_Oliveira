...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("USA", "alpha3"),
        ("840", "numeric"),
        # --- NOVOS TESTES PARA MATAR MUTANTES DO '_get_code_type' ---
        # ("US", "auto"),   # Testa o caminho alpha2 com formato automático
        # ("840", "auto"),  # Testa o caminho numérico com formato automático
    ],
)
